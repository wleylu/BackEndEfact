...
public class Consultation {
	...
	public Consultation(long id, Date dateRegle, String reference, String referenceFT, long montantDebite,
			...
			String statut, Date heure, String filiale) {
		super();
		this.id = id;
		this.dateRegle = dateRegle;
		this.reference = reference;
	...
	public String toString() {
		return "Consultation [id=" + id + ", dateRegle=" + dateRegle + ", reference=" + reference + ", referenceFT="
				+ referenceFT + ", montantDebite=" + montantDebite + ", numCpt=" + numCpt + ", typeRegle=" + typeRegle
				+ ", facturier=" + facturier + ", login=" + login + ", identifiant=" + identifiant + ", filiale="
				+ filiale + ", heure=" + heure + ", dtExpFacture=" + dtExpFacture + ", statut=" + statut + ", loginAdd="
				+ loginAdd + ", dateAdd=" + dateAdd + ", loginMaj=" + loginMaj + ", dateMaj=" + dateMaj + "]";
	}
