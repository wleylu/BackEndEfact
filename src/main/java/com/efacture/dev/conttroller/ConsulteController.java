...
// paie.setMontantFacture(paiement.getMontantFacture());
		 ...
		 * @PostMapping("/consultation/rechercheByFactAndRef") public
		 * ResponseEntity<Consultation> rechercheByFactAndRef(@RequestBody Consultation
		 * consultation){ Consultation consulte =
		 * consultationImpl.rechercheConsulteByFactAndRef(consultation.getFacturier(),
		 * consultation.getReference());
		 * //paie.setMontantFacture(paiement.getMontantFacture()); return
		 * ResponseEntity.ok(consulte); }
		 */
	...
	public ResponseEntity<Consultation> vueConsultation(@RequestBody Consultation consultation) {
		Consultation cons = consultationImpl.vueConsultation(consultation.getDateRegle(),
				...
				consultation.getHeure(), consultation.getFiliale());
		// paie.setMontantFacture(paiement.getMontantFacture());
