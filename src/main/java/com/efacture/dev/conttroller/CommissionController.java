...
public class CommissionController {
    ...
    public ResponseEntity<Commission> getCommissionParId(@PathVariable long idCommission){
        return ResponseEntity.ok(commissionImpl.getCommissionParId(idCommission));
    }
